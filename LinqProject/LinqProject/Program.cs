internal class Program
{
    private static void Main(string[] args)
    {
        ...
        List<Product> products = new List<Product>
        {
            ...
            new Product{ProductId=5,CategoryId=2,ProductName="Apple",QuantityPerUnit="4 GB Ram",UnitPrice=8000,UnitInStock=0 }
        };
        //test(products);
        ...
        {
            Console.WriteLine("{0}--{1}--{2}",productDto.ProductID,productDto.ProductName,productDto.CategoryName);
        }
